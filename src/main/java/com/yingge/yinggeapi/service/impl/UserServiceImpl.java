...
import com.yingge.yinggeapi.model.dto.user.UserQueryRequest;
import com.yingge.yinggeapi.model.enums.UserRoleEnum;
import com.yingge.yinggeapi.model.vo.LoginUserVO;
...
import static com.yingge.yinggeapi.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "yingge";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            // 3. 增加密钥（在用户注册的时候自动生成 accessKey secretKey）
